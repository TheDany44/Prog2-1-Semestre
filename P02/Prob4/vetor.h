...
/**
*  concatena 2 vetores
*  parametro: vec1 apontador para vetor1
*  parametro: vec2 apontador para vetor2
*  retorno: NULL se ocorrer um erro ou vec se for bem sucedido
*/
...
/**
*  devolve um novo vetor baralhado
*  parametro: vec apontador para vetor
*  retorno: NULL se ocorrer um erro ou o novo vetor se for bem sucedido
*/
