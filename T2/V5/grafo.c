    ...
    while(h->tamanho!=0){
        ...
        for(i=0;i<origem_no->tamanho;i++){
            ...
            if(diferenca>=0){
                ...
                if(nao_removido(vetor,tamanho,origem_no->arestas[i]->destino) && origem_no->arestas[i]->destino->p_acumulado>origem_no->p_acumulado+diferenca+duracao_voo){
    ...
    *n=0;
    ...
    while(h->tamanho!=0){
        ...
        for(i=0;i<origem_no->tamanho;i++){
            ...
            if(diferenca>=0){
                if(nao_removido(vetor,tamanho,origem_no->arestas[i]->destino) && origem_no->arestas[i]->destino->p_acumulado>origem_no->p_acumulado+1){
                    duracao_voo=difftime(mktime(&origem_no->arestas[i]->chegada),mktime(&origem_no->arestas[i]->partida));
