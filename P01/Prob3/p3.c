...
int main(){
    ...
    char link[100], beg[]="<a href=\"", *ref,pagina[100],end[]="\"", end2[]="</a>";
    f=fopen("pagina.html","r"); //abre o ficheiro
    
    while (fgets(link,100,f) != NULL){  //enquanto obtiver uma linha do ficheiro granda em link e faz:
