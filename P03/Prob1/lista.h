...
/**
 *  guarda numa lista todas as strings que contêm a substring
 *  parametro: lst apontador para a lista
 *  parametro: substring string que se pretende pesquisar
 *  retorno: NULL se tiver ocorrido um erro ou um endereço da nova lista
 */
lista* lista_pesquisa_substring(lista* lst,char *substring);

/**
 *  concateneia 2 listas
 *  parametro: lst1 apontador para a lista1
 *  parametro: lst2 apontador para a lista2
 *  retorno: NULL se tiver ocorrido um erro ou um apontador para a lst1 com o resultado da concatenação das duas listas
 */
...
/**
 *  Insere uma string de forma ordenada
 *  parametro: lst apontador para a lista
 *  parametro: inserir string a inserir na lista
